...
from gi.repository.Gtk import AccelFlags, SeparatorMenuItem, accel_groups_from_object
from gi.repository.Gdk import CONTROL_MASK, META_MASK, SHIFT_MASK
...
def accel_swap(item, group, skey, smod, dkey, dmod):
    ...
    item.add_accelerator('activate', group, ord(dkey), dmod, AccelFlags.VISIBLE)
